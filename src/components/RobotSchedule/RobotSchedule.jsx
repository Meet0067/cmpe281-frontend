...
class RobotSchedule extends React.Component {
    constructor(props) {
      ...
      const result1 = await axios
        .get(config.backEndURL+"/robot/all-robots-by-user-id?id="+ud.userId )
        .then(
          (res) => {
      ...
      this.setState({ robotList: result1 });
        ...
        .get(config.backEndURL+"/robot/schedule?id="+ud.userId )
        .then(
          (res) => {
              console.log("hellow world",res);
            return res.data;
      ...
      // this.setState({ robotList: result3 });
      ...
      render() {
        ...
        return (
          ...
          <div className="row container" >
            ...
            <div className="card  col-6 m-2 mb-1"  style={{width:'93%',backgroundColor:'black',paddingBottom:'20',color:'white',borderColor:'white'}}>
            ...
            <div className="card row m-2" style={{width:'93%',backgroundColor:'black',paddingBottom:'20',color:'white',borderColor:'white'}}>
           ...
           <table className="table table-hover table-striped " style={{color:'white'}}>
                    ...
                    <tbody>
                        ...
                        {Array.isArray(this.state.scheduleList) && this.state.scheduleList.map((data, i) => {
                            return (
                                <tr key={i} >
                                    <td style={{color:"white"}}>{data.robotName}</td>
                                    <td style={{color:"white"}}>{data.buildingName}</td>
                                    <td style={{color:"white"}}>{data.floorName}</td>
                                    <td style={{color:"white"}}>{data.roomName}</td>
                                    <td style={{color:"white"}}>{data.startDateTime}</td>
                                    <td style={{color:"white"}}>{data.endDateTime}</td>
