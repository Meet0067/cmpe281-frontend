...
class UserTable4 extends React.Component{
    ...
    fetchCats=async()=>{
      ...
      const url=config.backEndURL+ "/billing/user/simulation/"+ud.userId;
  ...
  render(){
    ...
    return (
      ...
      <div style={{ height: 300, width: '97%' }}>
        <div className="card-header text-white bg-info pt-2 pb-2 " style={{width: '97%', color : 'white'}}><b>Usage Details</b></div>
          <DataGrid
          style={{ color : 'white'}}
