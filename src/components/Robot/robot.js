    ...
    return (
      <div>
        ...
        <div>
          ...
          <br />
          <br />
          <div className={classes.fieldset} style = {{ backgroundColor : "white", width : "100%",color : "black", textAlign : "center"}} >
            <fieldset >
              <legend>Robots</legend>
              <div style={{backgroundColor:"white"}}>
              <TableContainer component={Paper} >
                <Table className= {classes.table} style = {{backgroundColor : "black", color : "white"}} aria-label="simple table">
                  <TableHead>
                    <TableRow>
                  ...
                  <TableBody >
                    {this.state.robotList.map((row) => (
                      <TableRow key={row.name} >
                        ...
                        <TableCell align="left" style={{color:"white"}}>{row.os}</TableCell>
                        <TableCell align="left" style={{color:"white"}}>
                          {row.robotType}
                        </TableCell>
                        <TableCell align="left" style={{color:"white"}}>
        ...
        <div>
          <fieldset>
            ...
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="simple table" style = {{backgroundColor : "black",color : "white"}}>
                <TableHead>
                  <TableRow>
